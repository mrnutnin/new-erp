...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('wms_issue_documents')) {
            Schema::table('wms_issue_documents', function (Blueprint $table): void {
        ...
        if (Schema::hasTable('wms_issue_lines')) {
            Schema::table('wms_issue_lines', function (Blueprint $table): void {
