...
| WMS/Purchasing | inventory Global Settings, active Item/Category/UOM counts, active account mapping ที่เกี่ยวข้อง | Purchase Document สถานะ Draft/Approved และ Cost Recalculation ที่ยังไม่ resolved ตาม Warehouse | `wms.items.view`, `purchasing.purchase-documents.view`, `wms.stock.view`, `wms.stock-valuation.view` |
