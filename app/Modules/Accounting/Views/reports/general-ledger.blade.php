        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <table class="table table-hover align-middle w-100" id="general-ledger-table"
                    ...
                    <thead><tr><th>วันที่</th><th>เลขที่</th><th>สมุด</th><th>เอกสารอ้างอิง</th><th>คำอธิบาย</th><th>Subledger</th><th class="text-end">เดบิต</th><th class="text-end">เครดิต</th><th class="text-end">จัดการ</th></tr></thead>
                </table>
            </div>
        </div>
    </div>
    ...
    <script>
        $(function () {
            ...
            var table = $table.DataTable($.extend(true, {}, window.erpDataTableDefaults, {
                ajax: {
                    url: $table.data('url'),
                    data: function (data) { data.period_id = $period.val(); data.account_id = $account.val(); },
