...
<div class="container-fluid px-3 px-lg-4 py-4">
    ...
    <div class="card border-0 shadow-sm mb-3"><div class="card-body p-3 p-lg-4"><div class="row g-3 align-items-end">
        ...
        <div class="col-md-2"><button class="btn btn-app-soft w-100" id="reconcile-filter" type="button"><i class="bx bx-filter-alt me-1" aria-hidden="true"></i>ใช้ตัวกรอง</button></div>
