...
class SaveDocumentSequenceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'document_type' => ['required', 'in:RECEIPT,PAYMENT,SALES_INVOICE,SALES_CREDIT_NOTE,PURCHASE_INVOICE,PURCHASE_CREDIT_NOTE,PURCHASE_ORDER,PURCHASE_REQUISITION,PURCHASE_RETURN,GOODS_RECEIPT,INVENTORY_ADJUSTMENT,INVENTORY_ISSUE,INVENTORY_RETURN,WMS_TRANSFER,STOCK_COUNT,SALES_RFQ,SALES_INTAKE,SALES_QUOTATION,SALES_ORDER,PHYSICAL_SALE_HS,PHYSICAL_SALE_IV,SALES_RETURN,ADVANCE_DEPOSIT_AI,BILLING_NOTE,CUSTOMER,SUPPLIER,LANDED_COST,PETTY_CASH,PETTY_CASH_TOP_UP,PETTY_CASH_CLEARING,EMPLOYEE_ADVANCE,EMPLOYEE_ADVANCE_CLEARING,INTERNAL_TRANSFER,ASSET_REGISTER,ASSET_CAPITALIZATION,ASSET_ADDITION,ASSET_TRANSFER,ASSET_COUNT,ASSET_MAINTENANCE,ASSET_DEPRECIATION,ASSET_IMPAIRMENT,ASSET_DISPOSAL', Rule::unique('finance_document_sequences')->withoutTrashed()->whereNull('warehouse_id')->ignore($sequence)],
