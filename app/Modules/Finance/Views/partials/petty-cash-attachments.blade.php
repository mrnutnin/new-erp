...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body p-3 p-lg-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-3">
            ...
            @if(auth()->user()->hasPermission($managePermission))<button class="btn btn-sm btn-app-soft" type="button" data-bs-toggle="collapse" data-bs-target="#petty-cash-attachment-form"><i class="bx bx-upload me-1" aria-hidden="true"></i>แนบเอกสาร</button>@endif
        </div>
