...
@section('content')
    <div class="container-fluid px-3 px-lg-4 py-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3 mb-4">
            ...
            @if (auth()->user()->hasPermission('finance.petty-cash.manage-funds'))<a class="btn btn-app-primary" href="{{ route('finance.petty-cash-funds.create') }}"><i class="bx bx-plus me-1" aria-hidden="true"></i>เพิ่มวงเงินสดย่อย</a>@endif
        </div>

        <div class="card border-0 shadow-sm mb-4" aria-labelledby="petty-cash-fund-filter-title"><div class="card-body p-3 p-lg-4"><div class="d-flex justify-content-between align-items-center gap-3 mb-3"><div><h2 id="petty-cash-fund-filter-title" class="h5 mb-1">ตัวกรอง</h2><p class="small text-secondary mb-0">กรองข้อมูลก่อนดูรายการ</p></div><button type="button" id="petty-cash-fund-filter-reset" class="btn btn-sm btn-app-soft">ล้างตัวกรอง</button></div><div class="row g-3"><div class="col-sm-6 col-lg-4"><label class="form-label" for="petty-cash-fund-status">สถานะ</label><select id="petty-cash-fund-status" class="form-select"><option value="">ทุกสถานะ</option><option value="1">ใช้งาน</option><option value="0">ปิดใช้งาน</option></select></div></div></div></div>
