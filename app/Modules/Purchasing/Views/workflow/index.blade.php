...
@section('title', 'คู่มือการทำงาน | Purchasing')

@section('content')
<div class="container-fluid px-3 px-lg-4 py-4">
    <p class="eyebrow mb-2">PURCHASING · WORKFLOW CENTER</p>
    <div class="d-flex flex-wrap justify-content-between align-items-end gap-3 mb-4">
        <div><h1 class="h3 mb-2">คู่มือการทำงาน Purchasing</h1><p class="text-secondary mb-0">ลำดับงานจัดซื้อและเจ้าหนี้ พร้อมผลกระทบต่อระบบ</p></div>
        @if($warehouse)
    ...
    <div class="tab-content">
        @foreach($workflowModes as $mode => $label)
            <div class="tab-pane fade {{ $mode === $defaultWorkflowMode ? 'show active' : '' }}" id="purchasing-workflow-{{ $mode }}">
