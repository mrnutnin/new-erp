...
<div class="pdf-tax-invoice">
    ...
    <x-platform::pdf-signatures :document="$requisition" :slots="[
        ['role' => 'prepared', 'label' => 'ผู้ขอซื้อ', 'name' => $requisition->createdBy?->name],
        ['role' => 'submitted', 'label' => 'ผู้ส่งอนุมัติ', 'name' => $requisition->submittedBy?->name],
        ['role' => 'approved', 'label' => 'ผู้อนุมัติ', 'name' => $requisition->approvedBy?->name],
    ]" />
