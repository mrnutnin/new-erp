...
<div class="pdf-tax-invoice pdf-readable">
    ...
    <table class="pdf-signatures pdf-signatures-three"><tr><td><div class="invoice-sign-space">&nbsp;</div><div>....................................</div><div>ผู้จัดทำ{{ $document->createdBy?->name ? ' · '.$document->createdBy->name : '' }}</div><div class="invoice-sign-date">วันที่ .......... / .......... / ..........</div></td><td class="invoice-sign-gap"></td><td><div class="invoice-sign-space">&nbsp;</div><div>....................................</div><div>ผู้อนุมัติ{{ $document->approvedBy?->name ? ' · '.$document->approvedBy->name : '' }}</div><div class="invoice-sign-date">{{ $document->approved_at ? 'อนุมัติ '.$document->approved_at->format('d/m/Y H:i') : 'วันที่ .......... / .......... / ..........' }}</div></td><td class="invoice-sign-gap"></td><td><div class="invoice-sign-space">&nbsp;</div><div>....................................</div><div>ผู้ลงบัญชี{{ $document->postedBy?->name ? ' · '.$document->postedBy->name : '' }}</div><div class="invoice-sign-date">{{ $document->posted_at ? 'ลงบัญชี '.$document->posted_at->format('d/m/Y H:i') : 'วันที่ .......... / .......... / ..........' }}</div></td></tr></table>
