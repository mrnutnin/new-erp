...
class GoodsReceiptLine extends Model
{
    ...
    protected function casts(): array { return ['purchase_quantity' => 'decimal:8', 'factor' => 'decimal:8', 'stock_quantity' => 'decimal:8', 'total_cost' => 'decimal:8', 'stock_unit_cost' => 'decimal:8', 'rounding_delta' => 'decimal:8', 'conversion_snapshot' => 'array']; }
    ...
    public function stockUom() { return $this->belongsTo(Uom::class, 'stock_uom_id'); }
    public function purchaseDocumentAllocations(): HasMany { return $this->hasMany(\App\Modules\Purchasing\Models\PurchaseDocumentReceiptAllocation::class); }
