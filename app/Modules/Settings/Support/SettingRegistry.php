...
class SettingRegistry
{
    public const DEFINITIONS = [
        ...
        'asset_enabled' => ['name' => 'เปิดใช้งาน Asset', 'description' => 'เปิดความสามารถด้านทะเบียนสินทรัพย์และค่าเสื่อมราคา', 'type' => 'boolean', 'allowed' => [true, false], 'default' => true, 'owner' => 'Settings', 'retroactive' => false],
        'asset_depreciation_proration' => ['name' => 'วิธีปันส่วนค่าเสื่อม', 'description' => 'ใช้รายวันหรือเต็มเดือน และ snapshot เมื่อสร้างชุดคำนวณค่าเสื่อม', 'type' => 'enum', 'allowed' => ['DAILY', 'FULL_MONTH'], 'default' => 'DAILY', 'owner' => 'Asset', 'retroactive' => false],
