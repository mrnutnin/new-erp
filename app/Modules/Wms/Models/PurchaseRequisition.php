...
class PurchaseRequisition extends Model
{
    ...
    protected $fillable = [
        'warehouse_id', 'branch_id', 'document_number', 'document_date', 'supplier_id', 'description', 'status',
        'rejection_reason', 'submitted_by', 'submitted_at', 'approved_by', 'approved_at',
        'voided_by', 'voided_at', 'void_reason', 'created_by', 'updated_by',
    ];
