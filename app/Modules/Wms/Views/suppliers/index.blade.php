...
@section('content')
    <div class="container-fluid px-3 px-lg-4 py-4">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-end gap-3 mb-4">
            ...
            @if (auth()->user()->hasPermission('wms.suppliers.create'))
            ...
            <div class="card-body p-3 p-lg-4">
                <div class="table-responsive">
                    <table
                        ...
                        data-can-update="{{ auth()->user()->hasPermission('wms.suppliers.update') ? 1 : 0 }}"
                        data-can-delete="{{ auth()->user()->hasPermission('wms.suppliers.delete') ? 1 : 0 }}"
                    >
                        <thead>
                            <tr>
                                <th>รหัส</th>
                                ...
                                <th>สถานะ</th>
                                @if (auth()->user()->hasPermission('wms.suppliers.update') || auth()->user()->hasPermission('wms.suppliers.delete'))
