...
@section('title', 'รับสินค้าผลิตเสร็จ | WMS')

@section('content')
<div class="container-fluid px-3 px-lg-4 py-4">
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-end gap-3 mb-4">
        <div><p class="eyebrow mb-2">WMS / PRODUCTION RECEIPT</p><h1 class="h3 mb-2">รับสินค้าผลิตเสร็จ</h1><p class="text-secondary mb-0">รับสินค้าเข้าคลังจากผลผลิต และตรวจสอบต้นทุนวัตถุดิบต้นทางก่อนลง Stock และบัญชี</p></div>
...
$(function () {
    ...
    window.erpAjaxDelete({button:'.js-production-receipt-delete',reload:'#production-finished-receipts-table',title:'ลบร่างใบรับผลิต?',text:'เอกสารร่างจะถูกลบและไม่สามารถกู้คืนได้',confirmButtonText:'ลบร่าง',cancelButtonText:'กลับ'});
});
</script>
@endpush
