...
@section('content')
    ...
    <div class="container-fluid px-3 px-lg-4 py-4">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-end gap-3 mb-4">
            ...
            @if (auth()->user()->hasPermission('wms.purchase-documents.create'))
            ...
            <div class="card-body p-3 p-lg-4">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle w-100" id="purchase-documents-table"
                           ...
                           data-has-actions="{{ auth()->user()->hasPermission('wms.purchase-documents.update') || auth()->user()->hasPermission('wms.purchase-documents.approve') || auth()->user()->hasPermission('wms.purchase-documents.post') || auth()->user()->hasPermission('wms.purchase-documents.inventory-post') || auth()->user()->hasPermission('wms.purchase-documents.void') || auth()->user()->hasPermission('wms.purchase-documents.inventory-reverse') || auth()->user()->hasPermission('wms.purchase-documents.delete') ? 1 : 0 }}">
