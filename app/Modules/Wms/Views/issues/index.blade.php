...
$(function () {
    ...
    var table = tableElement.DataTable($.extend(true, {}, window.erpDataTableDefaults, {
        ...
        order: [[1, 'desc'], [0, 'desc']], buttons: [window.erpExcelButton(tableElement)],
        columns: [
