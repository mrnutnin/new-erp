                    ...
                    <div class="col-12 col-lg-6">
                        <div class="border rounded-4 p-4 h-100">
                            ...
                            <form action="{{ route('installer.company', ['token' => $token]) }}" method="post" class="row g-3">
                                ...
                                <div class="col-md-6"><label class="form-label">เลขประจำตัวผู้เสียภาษี</label><input name="tax_id" class="form-control" inputmode="numeric" maxlength="13" value="{{ old('tax_id', $company?->tax_id) }}"></div>
