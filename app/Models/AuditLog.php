...
class AuditLog extends Model
{
    ...
    private const ACTION_LABELS = [
        ...
        'wms.cost_revaluation.resumed' => 'ส่ง Revaluation Run กลับเข้าคิว',
        'wms.cost_revaluation.cancelled' => 'ยกเลิก Revaluation Run',
        'wms.cost_revaluation.manual_triggered' => 'สั่ง Cost Propagation จากเอกสารด้วยตนเอง',
        ...
        'finance.petty_cash_fund.created' => 'สร้างวงเงินสดย่อย',
        'finance.petty_cash_fund.updated' => 'แก้ไขวงเงินสดย่อย',
        'finance.petty_cash_fund.deleted' => 'ลบวงเงินสดย่อย',
        'finance.petty_cash_clearing.created' => 'สร้างเอกสารเคลียร์เงินสดย่อย',
        'finance.petty_cash_clearing.updated' => 'แก้ไขเอกสารเคลียร์เงินสดย่อย',
        'finance.petty_cash_clearing.submitted' => 'ส่งเอกสารเคลียร์เงินสดย่อยเพื่ออนุมัติ',
        'finance.petty_cash_clearing.approved' => 'อนุมัติเอกสารเคลียร์เงินสดย่อย',
        'finance.petty_cash_clearing.posted' => 'ลงบัญชีเอกสารเคลียร์เงินสดย่อย',
        'finance.petty_cash_clearing.reversed' => 'กลับรายการเอกสารเคลียร์เงินสดย่อย',
        'finance.petty_cash_clearing.voided' => 'ยกเลิกเอกสารเคลียร์เงินสดย่อย',
